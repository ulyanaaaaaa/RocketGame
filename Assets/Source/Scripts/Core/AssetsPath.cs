public static class AssetsPath
{
    ...
    {
        public static string BigCloud = "Clouds/BigCloud";
        public static string Cloud = "Clouds/Cloud";
        public static string CloudFabrica = "Clouds/CloudFabrica";
        public static string SmallCloud = "Clouds/SmallCloud";
    }
    
    public static class StonesPath
    {
        public static string BigStone = "Stones/BigStone";
        public static string Stone = "Stones/Stone";
        public static string SmallStone = "Stones/SmallStone";
        public static string MiddleStone = "Stones/MiddleStone";
        public static string WidthStone = "Stones/WidthStone";
        public static string StoneFabrica = "Stones/StoneFabrica";
    }
    
    public static class FuelPath
    {
    ...
    {
        public static string InvisibleWall = "Environment/InvisibleWall";
    }
}
